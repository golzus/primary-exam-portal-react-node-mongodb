    ...
    >
      <Box sx={{ padding: '1rem', textAlign: 'center', position: 'relative' }}>
        ...
        {image ? (
          ...
          <FaSchool style={{ fontSize: '1.5rem', color: '#9B153B', margin: '0 auto 1rem' }} />
        )}
        {!isCollapsed && (
          <>
            ...
            <Typography variant="h7" component="div" sx={{ color: '#9B153B', fontSize: '0.7rem', fontWeight: 'bold' }}>
              {chosenNameClass}
            </Typography>
          </>
        )}
        <Box sx={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.7rem' }}>
                        ...
                        <div key={actionIndex}>
                          {actionCat.list.map((actionItem, actionIndex) => (
                            ...
                            >
                              ...
                              {!isCollapsed && <ListItemText primary={actionItem.title} sx={{ color: 'inherit', textAlign: 'right', fontSize: '0.7rem', fontWeight: 'bold' }} />}
                            </ListItem>
                          ))}
                        </div>
                      ))}
      ...
      <Box sx={{ textAlign: 'center', marginTop: 'auto', marginBottom: '1rem' }}>
        <IconButton component={NavLink} to="/" sx={{ color: '#9B153B' }}>
