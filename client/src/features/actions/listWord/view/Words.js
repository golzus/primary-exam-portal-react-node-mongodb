...
// import { useGetListWordsByIdMutation } from './ListWordApiSlice';
// import { useParams } from 'react-router-dom';
// import { ThemeProvider } from '@mui/material/styles';
// import theme from '../../../../theme';
// const Words = () => {
//   const [getListWordsById, { isSuccess, data: wordList, isLoading, isError: err }] = useGetListWordsByIdMutation();
//   const { _id } = useParams();
...
//             },
//             display: { xs: 'block', print: 'none' }, // Hide print button in print view
//           }}
//         >
//           <PrintIcon />
//         </Button>
//         <Box sx={{ height: '100%', width: '100%' }}>
//           <div id="printable-area" style={{ fontSize: '10px' }}> {/* Smaller font size for the table */}
//             <DataGrid
//               rows={rows}
//               columns={columns}
//               pageSize={10}
